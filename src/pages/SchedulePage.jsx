...
function SchedulePage() {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'date' && !presetDates.some(d => d.value === value)) {
      ...
      updated.customDateFormatted = d.toLocaleDateString('en-US', {
        weekday: 'long',
        month: '2-digit',
        day: '2-digit',
        year: 'numeric'
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full p-3 rounded-xl text-center appearance-none transition-all duration-200 pr-10 ${
                formData.date && !presetDates.some(d => d.value === formData.date)
                  ? 'bg-[#FFD700] text-black font-bold border-2 border-[#FFD700]'
            ...
            {formData.date && !presetDates.some(d => d.value === formData.date) && (
              <div className="absolute left-0 right-0 top-1/2 transform -translate-y-1/2 text-center text-black font-bold pointer-events-none">
