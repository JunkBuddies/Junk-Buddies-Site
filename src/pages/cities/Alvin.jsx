  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    >
      <iframe
        ...
        title="Junk Buddies Alvin Coverage Map"
      ></iframe>
    </div>
    ...
    <div className="text-gray-800" data-aos="fade-up">
      ...
      <ul className="space-y-4 text-base sm:text-lg leading-relaxed">
        <li>
          <span className="text-gold font-semibold">Central Alvin →</span>{" "}
          77511, 77512
        </li>
        <li>
          <span className="text-gold font-semibold">Nearby Communities →</span>{" "}
          77583 (Rosharon), 77584 (Pearland), 77581 (Pearland East), 77546 (Friendswood), 
          77578 (Manvel)
        </li>
        <li>
          <span className="text-gold font-semibold">Extended Coverage →</span>{" "}
          77598 (Webster), 77545 (Fresno), 77588 (Iowa Colony), 77566 (Lake Jackson), 
          77422 (Brazoria)
        </li>
        <li>
          <span className="text-gold font-semibold">Additional ZIP Codes →</span>{" "}
          77534, 77515, 77480, 77531, 77541, 77577, 77542
        </li>
        <li>
          <span className="text-gold font-semibold">Greater Houston Metro →</span>{" "}
          Pasadena, Pearland, Friendswood, League City, Sugar Land, Baytown, Richmond, 
          Rosenberg, Missouri City, Cypress, Spring, The Woodlands, Tomball, Deer Park, La Porte
        </li>
      </ul>
    </div>
  </div>
...
<section className="relative w-full bg-white overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-16 px-6">
      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="w-40 h-40 flex items-center justify-center rounded-full border-4 border-gold shadow-xl relative">
          <p className="text-center font-bold text-gold text-sm">
            Official<br />Junk Buddies<br />Alvin, TX
          </p>
        </div>
        {/* Trust Indicators */}
    ...
    <div className="text-gray-800" data-aos="fade-up">
      <h2 className="text-3xl sm:text-4xl font-bold text-gold mb-6">
        The Official Junk Buddies — Serving Alvin, Texas with Pride
      </h2>
      ...
      <p className="text-base sm:text-lg leading-relaxed font-semibold">
        When you choose Junk Buddies in Alvin, you’re choosing the original 
