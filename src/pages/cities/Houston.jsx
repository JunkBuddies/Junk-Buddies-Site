...
const Houston = () => {
  return (
    <div className="min-h-screen bg-gray-900 text-white px-6 py-12">
      ...
      {/* Google Map Embed */}
      <div className="w-full max-w-5xl mx-auto mb-12 border-4 border-gold rounded-xl overflow-hidden shadow-lg">
        <iframe
          title="Houston Service Map"
          src="https://www.google.com/maps/d/u/0/embed?mid=1zvhq-YOUR-CUSTOM-MAP-ID" // ← REPLACE with your custom map URL if needed
          width="100%"
          height="450"
          loading="lazy"
          style={{ border: 0 }}
