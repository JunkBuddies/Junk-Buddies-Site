      ...
      <div className="relative bg-gray-900 text-white min-h-screen flex flex-col justify-center items-center text-center px-6">
        ...
        <div className="relative z-10 mt-20 max-w-6xl w-full">
          ...
          <div className="how-it-works-carousel">
            <div
              ref={setCardRef}
              className="how-card bg-gradient-to-br from-gray-300 to-gray-500 text-black shadow-xl border border-gray-400"
            >
            ...
            <div
              ref={setCardRef}
              className="howitworks-badge-card how-card bg-gradient-to-br from-gray-300 to-gray-500 text-black shadow-xl border border-gray-400"
            >
